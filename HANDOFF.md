...
- SDL2 top-down tile renderer now exists as a no-asset prototype:
  ...
  - Current atlas contract: 24x24 tiles, 7 columns x 4 rows, row-major categories: darkness, floor, wall, door, up stairs, down stairs, trap, glyph, shop, rubble, ore vein, object, food/anodyne object, scroll/book object, potion/flask object, weapon/tool object, armor object, ray gun/launcher object, ammo object, money object, jewelry object, device/chest object, generic monster, automata, undead/demon, beast, humanoid, player.
