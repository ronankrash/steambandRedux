...
static const byte store_table[MAX_STORES-2][STORE_CHOICES][2] =
{
...

	{
		...
		{ TV_FOOD, SV_FOOD_RESTORE_STR },
		{ TV_FOOD, SV_FOOD_RESTORE_CON },
		...
		{ TV_TONIC, SV_TONIC_RES_STR },
		{ TV_TONIC, SV_TONIC_RES_INT },
		{ TV_TONIC, SV_TONIC_RES_WIS },
		{ TV_TONIC, SV_TONIC_RES_DEX },
		{ TV_TONIC, SV_TONIC_RES_CON },
